...
#   docker run -d -p 6981:6981 -e HME_SUPERADMIN_USERNAME=liuyuquan -e HME_SUPERADMIN_PASSWORD=你的密码 \
...
# 超级管理员登录凭据在运行时通过 HME_SUPERADMIN_USERNAME/HME_SUPERADMIN_PASSWORD 注入
