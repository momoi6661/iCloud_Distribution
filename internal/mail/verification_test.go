...
func TestExtractVerificationCode(t *testing.T) {
	tests := []struct {
		...
		{"Reject mixed English suffix", "A1B2C3 is your verification code", ""},
		...
		{"Reject mixed Chinese security code", "本次安全码：A7K92P", ""},
		...
		{"Reject unknown language mixed code", "次の文字列を入力してください\nX4M8Q2\n10 分間有効です", ""},
		{"Reject mixed code with separators", "Use this login code: A7-K9-2P", ""},
		...
		{"Reject visible mixed code from HTML", `<div data-template="U001"><p>Use this verification code</p><strong>A7K92P</strong></div>`, ""},
		{"Reject explicitly labelled mixed code", "Your verification code is A1234", ""},
		{"Stop before following word", "Your code is: 432191 Please use this code to complete your application.", "432191"},
